...
pub mod tables {
    ...
    const PAWN_TABLE_MIDGAME: [i32; 64] = [
          0,   0,   0,   0,   0,   0,  0,   0,
    ...
    const KNIGHT_TABLE_MIDGAME: [i32; 64] = [
    ...
    const BISHOP_TABLE_MIDGAME: [i32; 64] = [
    ...
    const ROOK_TABLE_MIDGAME: [i32; 64] = [
    ...
    const QUEEN_TABLE_MIDGAME: [i32; 64] = [
    ...
    pub const PIECE_TABLES: PieceTables = PieceTables([
        [
            PAWN_TABLE_MIDGAME, 
            BISHOP_TABLE_MIDGAME, 
            KNIGHT_TABLE_MIDGAME, 
            ROOK_TABLE_MIDGAME, 
            QUEEN_TABLE_MIDGAME, 
            KING_TABLE_MIDGAME,
        ],
