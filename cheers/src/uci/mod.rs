...
uci_options![
    ...
    FpDepth(Spin<i8> { default: FP_DEPTH, min: 1, max: 10 }),
    FpConst(Spin<i16> { default: FP_CONST, min: 0, max: 300 }),
    FpDepthMargin(Spin<i16> { default: FP_DEPTH_MARGIN, min: 0, max: 300 }),
