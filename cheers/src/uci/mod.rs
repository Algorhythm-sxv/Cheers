...
uci_options![
    ...
    NmpImprovingReduction(Spin<i8> { default: NMP_IMPROVING_REDUCTION, min: -5, max: 5 }),
    ...
    RfpImprovingMargin(Spin<i16> { default: RFP_IMPROVING_MARGIN, min: -50, max: 50 }),
    LmpDepth(Spin<i8> { default: LMP_DEPTH, min: 0, max: 10 }),
    LmpConst(Spin<i32> { default: (LMP_CONST * 100.0) as i32, min: 0, max: 500 }),
    LmpConstScale(Spin<i32> { default: (LMP_CONST_SCALE * 100.0) as i32, min: 0, max: 500}),
    LmpImproving(Spin<i32> { default: (LMP_IMPROVING * 100.0) as i32, min: 0, max: 500}),
    LmpImprovingScale(Spin<i32> { default: (LMP_IMPROVING_SCALE * 100.0) as i32, min: 0, max: 500}),
    LmrConst(Spin<i32> { default: (LMR_CONST * 100.0) as i32, min: 0, max: 500}),
    LmrDivisor(Spin<i32> { default: (LMR_DIVISOR * 100.0) as i32, min: 0, max: 500}),
    LmrImprovingConst(Spin<i32> { default: (LMR_IMPROVING_CONST * 100.0) as i32, min: 0, max: 500}),
    LmrImprovingDivisor(Spin<i32> { default: (LMR_IMPROVING_DIVISOR * 100.0) as i32, min: 0, max: 500}),
