    ...
    for line in stdin().lock().lines() {
        ...
        match cmd {
            ...
            uci::UciCommand::SetOption(opt) => match opt {
                ...
                uci::UciOption::PvsFulldepth(n) => options.pvs_fulldepth = n as i8,
                uci::UciOption::DeltaPruningMargin(n) => options.delta_pruning_margin = n as i16,
                uci::UciOption::FpMargin1(n) => options.fp_margin_1 = n as i16,
                uci::UciOption::FpMargin2(n) => options.fp_margin_2 = n as i16,
                uci::UciOption::FpMargin3(n) => options.fp_margin_3 = n as i16,
                uci::UciOption::RfpMargin(n) => options.rfp_margin = n as i16,
                uci::UciOption::LmpDepth(n) => options.lmp_depth = n as i8,
                uci::UciOption::LmpMargin(n) => options.lmp_margin = n as i16,
                uci::UciOption::IirDepth(n) => options.iir_depth = n as i8,
            },
