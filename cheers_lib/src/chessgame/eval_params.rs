...
pub struct EvalParams {
    ...
    pub pawn_shield_1: i32,
    pub pawn_shield_2: i32,
...
pub const EVAL_PARAMS: EvalParams = EvalParams {
    ...
    pawn_shield_2: PAWN_SHIELD_2,
    passed_pawn_bonus: PASSED_PAWN_BONUS,
    double_pawn_penalty: DOUBLE_PAWN_PENALTY,
};

#[derive(Copy, Clone, Debug, Default)]
pub struct PieceValues(pub [i32; 6]);
...
pub const PASSED_PAWN_BONUS: i32 = 100;
pub const DOUBLE_PAWN_PENALTY: i32 = 20;
...
pub struct PieceTables([[[i32; 64]; 6]; 2]);
impl std::ops::Index<(GamePhase, PieceIndex)> for PieceTables {
    type Output = [i32; 64];
